...
export function AdminWorkspace({
  ...
  const journeySteps = [
    ...
    { icon: ClipboardList, title: "English testi", description: "Admin testni biriktiradi va credential beradi." },
